...
export class ArticleServiceService {
  ...
  public operationQuantityArticle: OperationQuantity = { articuleId: 0, operation: '' };
  ...
  changeQuantity(operationQuantityArticle: OperationQuantity): QuantityArticle[] {
    ...
    if (operationQuantityArticle.operation === 'sum') {
      const existingItem = this.actualId.find(e => e.id === operationQuantityArticle.articuleId);
      if (!existingItem) {
